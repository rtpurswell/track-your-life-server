...
router.delete("/:id",[auth, validateObjectId], async(req,res)=> {
    ...
    const habbit = await Habbit.deleteOne({userId:user._id, _id:req.params.id});
    habbit.records = await HabbitRecord.deleteMany({userId:user._id, habbitId:req.params.id});
